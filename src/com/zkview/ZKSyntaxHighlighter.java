...
public class ZKSyntaxHighlighter extends SyntaxHighlighterBase {
    ...
    public TextAttributesKey[] getTokenHighlights(IElementType tokenType) {
        if (tokenType.equals(ZKTypes.SEPARATOR)) {
            return SEPARATOR_KEYS;
        } else if (tokenType.equals(ZKTypes.KEY)) {
            return KEY_KEYS;
        } else if (tokenType.equals(ZKTypes.VALUE)) {
            return VALUE_KEYS;
        } else if (tokenType.equals(ZKTypes.COMMENT)) {
            return COMMENT_KEYS;
