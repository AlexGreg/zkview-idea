...
/**
 * http://www.zkoss.org/2005/zul:listheaderType interface.
 */
public interface Listheader extends DomElement {
	 ...
	 */
	@NotNull
	GenericAttributeValue<String> getImage();


	/**
	 * Returns the value of the imageContent child.
	 * @return the value of the imageContent child.
	 */
	@NotNull
	GenericAttributeValue<String> getImageContent();


	/**
	 * Returns the value of the hoverImage child.
	 * @return the value of the hoverImage child.
	 */
	@NotNull
	GenericAttributeValue<String> getHoverImage();


	/**
	 * Returns the value of the hoverImageContent child.
	 * @return the value of the hoverImageContent child.
	 */
	@NotNull
	GenericAttributeValue<String> getHoverImageContent();
	 ...
	 */
	@NotNull
	GenericAttributeValue<String> getAlign();


	/**
	 * Returns the value of the valign child.
	 * @return the value of the valign child.
	 */
	@NotNull
	GenericAttributeValue<String> getValign();
	...
	/**
	 * Returns the value of the sortDirection child.
	 * @return the value of the sortDirection child.
	 */
	@NotNull
	GenericAttributeValue<String> getSortDirection();


	/**
	 * Returns the value of the sortAscending child.
	 * @return the value of the sortAscending child.
	 */
	@NotNull
	GenericAttributeValue<String> getSortAscending();


	/**
	 * Returns the value of the sortDescending child.
	 * @return the value of the sortDescending child.
	 */
	@NotNull
	GenericAttributeValue<String> getSortDescending();
	...
	/**
	 * Returns the value of the onSort child.
	 * @return the value of the onSort child.
	 */
	@NotNull
	GenericAttributeValue<String> getOnSort();


	/**
	 * Returns the value of the onGroup child.
	 * @return the value of the onGroup child.
	 */
	@NotNull
	GenericAttributeValue<String> getOnGroup();


	/**
	 * Returns the value of the onUngroup child.
	 * @return the value of the onUngroup child.
	 */
	@NotNull
	GenericAttributeValue<String> getOnUngroup();
