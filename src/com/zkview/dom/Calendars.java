...
/**
 * http://www.zkoss.org/2005/zul:calendarsType interface.
 */
public interface Calendars extends DomElement {
	...
	/**
	 * Returns the value of the days child.
	 * @return the value of the days child.
	 */
	@NotNull
	GenericAttributeValue<Integer> getDays();


	/**
	 * Returns the value of the beginTime child.
	 * @return the value of the beginTime child.
	 */
	@NotNull
	GenericAttributeValue<Integer> getBeginTime();
	 ...
	 */
	@NotNull
	GenericAttributeValue<Integer> getEndTime();


	/**
	 * Returns the value of the timeslots child.
	 * @return the value of the timeslots child.
	 */
	@NotNull
	GenericAttributeValue<Integer> getTimeslots();
	...
	/**
	 * Returns the value of the firstDayOfWeek child.
	 * @return the value of the firstDayOfWeek child.
	 */
	@NotNull
	GenericAttributeValue<String> getFirstDayOfWeek();
	...
	/**
	 * Returns the value of the dateFormatter child.
	 * @return the value of the dateFormatter child.
	 */
	@NotNull
	GenericAttributeValue<String> getDateFormatter();
	 ...
	 */
	@NotNull
	GenericAttributeValue<String> getTimeZone();


	/**
	 * Returns the value of the onEventCreate child.
	 * @return the value of the onEventCreate child.
	 */
	@NotNull
	GenericAttributeValue<String> getOnEventCreate();


	/**
	 * Returns the value of the onEventEdit child.
	 * @return the value of the onEventEdit child.
	 */
	@NotNull
	GenericAttributeValue<String> getOnEventEdit();


	/**
	 * Returns the value of the onEventUpdate child.
	 * @return the value of the onEventUpdate child.
	 */
	@NotNull
	GenericAttributeValue<String> getOnEventUpdate();


	/**
	 * Returns the value of the onDayClick child.
	 * @return the value of the onDayClick child.
	 */
	@NotNull
	GenericAttributeValue<String> getOnDayClick();


	/**
	 * Returns the value of the onWeekClick child.
	 * @return the value of the onWeekClick child.
	 */
	@NotNull
	GenericAttributeValue<String> getOnWeekClick();
