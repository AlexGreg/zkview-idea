...
/**
 * http://www.zkoss.org/2005/zul:appletType interface.
 */
public interface Applet extends DomElement {
	...
	/**
	 * Returns the value of the codebase child.
	 * @return the value of the codebase child.
	 */
	@NotNull
	GenericAttributeValue<String> getCodebase();
	 ...
	 */
	@NotNull
	GenericAttributeValue<String> getArchive();
	...
	/**
	 * Returns the value of the hspace child.
	 * @return the value of the hspace child.
	 */
	@NotNull
	GenericAttributeValue<String> getHspace();


	/**
	 * Returns the value of the vspace child.
	 * @return the value of the vspace child.
	 */
	@NotNull
	GenericAttributeValue<String> getVspace();


	/**
	 * Returns the value of the mayscript child.
	 * @return the value of the mayscript child.
	 */
	@NotNull
	GenericAttributeValue<String> getMayscript();


	/**
	 * Returns the value of the params child.
	 * @return the value of the params child.
	 */
	@NotNull
	GenericAttributeValue<String> getParams();
