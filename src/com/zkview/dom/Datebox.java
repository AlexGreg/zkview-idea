...
/**
 * http://www.zkoss.org/2005/zul:dateboxType interface.
 */
public interface Datebox extends DomElement {
	...
	/**
	 * Returns the value of the format child.
	 * @return the value of the format child.
	 */
	@NotNull
	...
	/**
	 * Returns the value of the lenient child.
	 * @return the value of the lenient child.
	 */
	@NotNull
	GenericAttributeValue<String> getLenient();
	...
	/**
	 * Returns the value of the displayedTimeZones child.
	 * @return the value of the displayedTimeZones child.
	 */
	@NotNull
	GenericAttributeValue<String> getDisplayedTimeZones();


	/**
	 * Returns the value of the timeZonesReadonly child.
	 * @return the value of the timeZonesReadonly child.
	 */
	@NotNull
	GenericAttributeValue<String> getTimeZonesReadonly();
	...
	/**
	 * Returns the value of the weekOfYear child.
	 * @return the value of the weekOfYear child.
	 */
	@NotNull
	GenericAttributeValue<String> getWeekOfYear();
