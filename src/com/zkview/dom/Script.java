...
/**
 * http://www.zkoss.org/2005/zul:scriptType interface.
 */
public interface Script extends DomElement {
	...
	/**
	 * Returns the value of the charset child.
	 * @return the value of the charset child.
	 */
	@NotNull
	...
	/**
	 * Returns the value of the defer child.
	 * @return the value of the defer child.
	 */
	@NotNull
	GenericAttributeValue<String> getDefer();
