...
/**
 * http://www.zkoss.org/2005/zul:areaType interface.
 */
public interface Area extends DomElement {
	...
	/**
	 * Returns the value of the shape child.
	 * @return the value of the shape child.
	 */
	@NotNull
	GenericAttributeValue<String> getShape();


	/**
	 * Returns the value of the coords child.
	 * @return the value of the coords child.
	 */
	@NotNull
	GenericAttributeValue<String> getCoords();
