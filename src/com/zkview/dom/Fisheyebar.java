...
/**
 * http://www.zkoss.org/2005/zul:fisheyebarType interface.
 */
public interface Fisheyebar extends DomElement {
	...
	/**
	 * Returns the value of the itemWidth child.
	 * @return the value of the itemWidth child.
	 */
	@NotNull
	GenericAttributeValue<Integer> getItemWidth();


	/**
	 * Returns the value of the itemHeight child.
	 * @return the value of the itemHeight child.
	 */
	@NotNull
	GenericAttributeValue<Integer> getItemHeight();


	/**
	 * Returns the value of the itemMaxWidth child.
	 * @return the value of the itemMaxWidth child.
	 */
	@NotNull
	GenericAttributeValue<Integer> getItemMaxWidth();


	/**
	 * Returns the value of the itemMaxHeight child.
	 * @return the value of the itemMaxHeight child.
	 */
	@NotNull
	GenericAttributeValue<Integer> getItemMaxHeight();


	/**
	 * Returns the value of the itemPadding child.
	 * @return the value of the itemPadding child.
	 */
	@NotNull
	GenericAttributeValue<Integer> getItemPadding();
	...
	/**
	 * Returns the value of the attachEdge child.
	 * @return the value of the attachEdge child.
	 */
	@NotNull
	GenericAttributeValue<String> getAttachEdge();


	/**
	 * Returns the value of the labelEdge child.
	 * @return the value of the labelEdge child.
	 */
	@NotNull
	GenericAttributeValue<String> getLabelEdge();


	/**
	 * Returns the value of the onChildAdded child.
	 * @return the value of the onChildAdded child.
	 */
	@NotNull
	GenericAttributeValue<String> getOnChildAdded();


	/**
	 * Returns the value of the onChildRemoved child.
	 * @return the value of the onChildRemoved child.
	 */
	@NotNull
	GenericAttributeValue<String> getOnChildRemoved();
