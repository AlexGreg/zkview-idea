...
/**
 * http://www.zkoss.org/2005/zul:dropuploadType interface.
 */
public interface Dropupload extends DomElement {
	...
	/**
	 * Returns the value of the detection child.
	 * @return the value of the detection child.
	 */
	@NotNull
	GenericAttributeValue<String> getDetection();


	/**
	 * Returns the value of the native child.
	 * @return the value of the native child.
	 */
	@NotNull
	GenericAttributeValue<String> getNative();
