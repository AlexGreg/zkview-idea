...
/**
 * http://www.zkoss.org/2005/zul:flashchartType interface.
 */
public interface Flashchart extends DomElement {
	...
	/**
	 * Returns the value of the chartStyle child.
	 * @return the value of the chartStyle child.
	 */
	@NotNull
	GenericAttributeValue<String> getChartStyle();
