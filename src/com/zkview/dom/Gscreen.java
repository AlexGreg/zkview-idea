...
/**
 * http://www.zkoss.org/2005/zul:gscreenType interface.
 */
public interface Gscreen extends DomElement {
	...
	/**
	 * Returns the value of the offsetX child.
	 * @return the value of the offsetX child.
	 */
	@NotNull
	GenericAttributeValue<String> getOffsetX();


	/**
	 * Returns the value of the offsetY child.
	 * @return the value of the offsetY child.
	 */
	@NotNull
	GenericAttributeValue<String> getOffsetY();


	/**
	 * Returns the value of the screenX child.
	 * @return the value of the screenX child.
	 */
	@NotNull
	GenericAttributeValue<String> getScreenX();


	/**
	 * Returns the value of the screenY child.
	 * @return the value of the screenY child.
	 */
	@NotNull
	GenericAttributeValue<String> getScreenY();
