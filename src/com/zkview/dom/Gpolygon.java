...
/**
 * http://www.zkoss.org/2005/zul:gpolygonType interface.
 */
public interface Gpolygon extends DomElement {
	...
	/**
	 * Returns the value of the points child.
	 * @return the value of the points child.
	 */
	@NotNull
	GenericAttributeValue<String> getPoints();
	 ...
	 */
	@NotNull
	GenericAttributeValue<Integer> getWeight();


	/**
	 * Returns the value of the opacity child.
	 * @return the value of the opacity child.
	 */
	@NotNull
	GenericAttributeValue<Integer> getOpacity();


	/**
	 * Returns the value of the numLevels child.
	 * @return the value of the numLevels child.
	 */
	@NotNull
	GenericAttributeValue<Integer> getNumLevels();


	/**
	 * Returns the value of the outline child.
	 * @return the value of the outline child.
	 */
	@NotNull
	GenericAttributeValue<String> getOutline();


	/**
	 * Returns the value of the fill child.
	 * @return the value of the fill child.
	 */
	@NotNull
	GenericAttributeValue<String> getFill();


	/**
	 * Returns the value of the fillColor child.
	 * @return the value of the fillColor child.
	 */
	@NotNull
	GenericAttributeValue<String> getFillColor();


	/**
	 * Returns the value of the fillOpacity child.
	 * @return the value of the fillOpacity child.
	 */
	@NotNull
	GenericAttributeValue<Integer> getFillOpacity();
