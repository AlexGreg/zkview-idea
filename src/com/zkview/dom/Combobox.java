...
/**
 * http://www.zkoss.org/2005/zul:comboboxType interface.
 */
public interface Combobox extends DomElement {
	...
	/**
	 * Returns the value of the inplace child.
	 * @return the value of the inplace child.
	 */
	@NotNull
	GenericAttributeValue<String> getInplace();


	/**
	 * Returns the value of the instant child.
	 * @return the value of the instant child.
	 */
	@NotNull
	GenericAttributeValue<String> getInstant();
	...
	/**
	 * Returns the value of the onChanging child.
	 * @return the value of the onChanging child.
	 */
	@NotNull
	GenericAttributeValue<String> getOnChanging();


	/**
	 * Returns the value of the onFocus child.
	 * @return the value of the onFocus child.
	 */
	@NotNull
	GenericAttributeValue<String> getOnFocus();


	/**
	 * Returns the value of the onBlur child.
	 * @return the value of the onBlur child.
	 */
	@NotNull
	GenericAttributeValue<String> getOnBlur();
	...
	/**
	 * Returns the value of the autocomplete child.
	 * @return the value of the autocomplete child.
	 */
	@NotNull
	GenericAttributeValue<String> getAutocomplete();


	/**
	 * Returns the value of the autodrop child.
	 * @return the value of the autodrop child.
	 */
	@NotNull
	GenericAttributeValue<String> getAutodrop();


	/**
	 * Returns the value of the buttonVisible child.
	 * @return the value of the buttonVisible child.
	 */
	@NotNull
	GenericAttributeValue<String> getButtonVisible();


	/**
	 * Returns the value of the constraint child.
	 * @return the value of the constraint child.
	 */
	@NotNull
	GenericAttributeValue<String> getConstraint();
