...
/**
 * http://www.zkoss.org/2005/zul:sliderType interface.
 */
public interface Slider extends DomElement {
	...
	/**
	 * Returns the value of the curpos child.
	 * @return the value of the curpos child.
	 */
	@NotNull
	GenericAttributeValue<Integer> getCurpos();


	/**
	 * Returns the value of the maxpos child.
	 * @return the value of the maxpos child.
	 */
	@NotNull
	GenericAttributeValue<Integer> getMaxpos();


	/**
	 * Returns the value of the slidingtext child.
	 * @return the value of the slidingtext child.
	 */
	@NotNull
	GenericAttributeValue<String> getSlidingtext();
