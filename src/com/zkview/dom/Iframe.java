...
/**
 * http://www.zkoss.org/2005/zul:iframeType interface.
 */
public interface Iframe extends DomElement {
	...
	/**
	 * Returns the value of the scrolling child.
	 * @return the value of the scrolling child.
	 */
	@NotNull
	GenericAttributeValue<String> getScrolling();
	...
	/**
	 * Returns the value of the onURIChange child.
	 * @return the value of the onURIChange child.
	 */
	@NotNull
	GenericAttributeValue<String> getOnURIChange();
