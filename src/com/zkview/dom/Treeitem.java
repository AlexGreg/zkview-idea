...
/**
 * http://www.zkoss.org/2005/zul:treeitemType interface.
 */
public interface Treeitem extends DomElement {
	...
	/**
	 * Returns the value of the checkable child.
	 * @return the value of the checkable child.
	 */
	@NotNull
	GenericAttributeValue<String> getCheckable();
	...
	/**
	 * Returns the value of the treerow child.
	 * @return the value of the treerow child.
	 */
	@NotNull
	@Required
	Treerow getTreerow();
