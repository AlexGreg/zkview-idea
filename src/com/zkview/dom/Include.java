...
/**
 * http://www.zkoss.org/2005/zul:includeType interface.
 */
public interface Include extends DomElement {
	 ...
	 */
	@NotNull
	GenericAttributeValue<String> getLocalized();


	/**
	 * Returns the value of the progressing child.
	 * @return the value of the progressing child.
	 */
	@NotNull
	GenericAttributeValue<String> getProgressing();
