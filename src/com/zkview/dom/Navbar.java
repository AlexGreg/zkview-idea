...
/**
 * http://www.zkoss.org/2005/zul:navbarType interface.
 */
public interface Navbar extends DomElement {
	...
	/**
	 * Returns the value of the collapsed child.
	 * @return the value of the collapsed child.
	 */
	@NotNull
	GenericAttributeValue<String> getCollapsed();
