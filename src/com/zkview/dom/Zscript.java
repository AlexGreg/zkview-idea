...
/**
 * http://www.zkoss.org/2005/zul:zscriptType interface.
 */
public interface Zscript extends DomElement {
	...
	/**
	 * Returns the value of the deferred child.
	 * @return the value of the deferred child.
	 */
	@NotNull
	GenericAttributeValue<String> getDeferred();
