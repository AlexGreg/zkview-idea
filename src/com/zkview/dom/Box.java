...
/**
 * http://www.zkoss.org/2005/zul:boxType interface.
 */
public interface Box extends DomElement {
	...
	/**
	 * Returns the value of the spacing child.
	 * @return the value of the spacing child.
	 */
	@NotNull
	...
	/**
	 * Returns the value of the widths child.
	 * @return the value of the widths child.
	 */
	@NotNull
	GenericAttributeValue<String> getWidths();


	/**
	 * Returns the value of the heights child.
	 * @return the value of the heights child.
	 */
	@NotNull
	GenericAttributeValue<String> getHeights();
	...
	/**
	 * Returns the value of the pack child.
	 * @return the value of the pack child.
	 */
	@NotNull
	GenericAttributeValue<String> getPack();
