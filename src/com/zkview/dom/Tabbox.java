...
/**
 * http://www.zkoss.org/2005/zul:tabboxType interface.
 */
public interface Tabbox extends DomElement {
	...
	/**
	 * Returns the value of the tabscroll child.
	 * @return the value of the tabscroll child.
	 */
	@NotNull
	GenericAttributeValue<String> getTabscroll();


	/**
	 * Returns the value of the panelSpacing child.
	 * @return the value of the panelSpacing child.
	 */
	@NotNull
	GenericAttributeValue<String> getPanelSpacing();
	...
	/**
	 * Returns the value of the selectedTab child.
	 * @return the value of the selectedTab child.
	 */
	@NotNull
	GenericAttributeValue<String> getSelectedTab();


	/**
	 * Returns the value of the selectedPanel child.
	 * @return the value of the selectedPanel child.
	 */
	@NotNull
	GenericAttributeValue<String> getSelectedPanel();
	...
	/**
	 * Returns the value of the maximalHeight child.
	 * @return the value of the maximalHeight child.
	 */
	@NotNull
	GenericAttributeValue<String> getMaximalHeight();
