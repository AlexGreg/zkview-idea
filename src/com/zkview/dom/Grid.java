...
/**
 * http://www.zkoss.org/2005/zul:gridType interface.
 */
public interface Grid extends DomElement {
	...
	/**
	 * Returns the value of the rowRenderer child.
	 * @return the value of the rowRenderer child.
	 */
	@NotNull
	GenericAttributeValue<String> getRowRenderer();
	...
	/**
	 * Returns the value of the foot child.
	 * @return the value of the foot child.
	 */
	@NotNull
	@Required
	Foot getFoot();
