...
/**
 * http://www.zkoss.org/2005/zul:toolbarbuttonType interface.
 */
public interface Toolbarbutton extends DomElement {
	...
	/**
	 * Returns the value of the upload child.
	 * @return the value of the upload child.
	 */
	@NotNull
	GenericAttributeValue<String> getUpload();
