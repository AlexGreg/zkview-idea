...
/**
 * http://www.zkoss.org/2005/zul:fckeditorType interface.
 */
public interface Fckeditor extends DomElement {
	...
	/**
	 * Returns the value of the toolbarSet child.
	 * @return the value of the toolbarSet child.
	 */
	@NotNull
	GenericAttributeValue<String> getToolbarSet();
