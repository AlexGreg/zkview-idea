...
/**
 * http://www.zkoss.org/2005/zul:audioType interface.
 */
public interface Audio extends DomElement {
	...
	/**
	 * Returns the value of the preload child.
	 * @return the value of the preload child.
	 */
	@NotNull
	GenericAttributeValue<String> getPreload();


	/**
	 * Returns the value of the controls child.
	 * @return the value of the controls child.
	 */
	@NotNull
	GenericAttributeValue<String> getControls();


	/**
	 * Returns the value of the loop child.
	 * @return the value of the loop child.
	 */
	@NotNull
	GenericAttributeValue<String> getLoop();


	/**
	 * Returns the value of the autostart child.
	 * @return the value of the autostart child.
	 */
	@NotNull
	GenericAttributeValue<String> getAutostart();


	/**
	 * Returns the value of the autoplay child.
	 * @return the value of the autoplay child.
	 */
	@NotNull
	GenericAttributeValue<String> getAutoplay();
