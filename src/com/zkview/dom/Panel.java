...
/**
 * http://www.zkoss.org/2005/zul:panelType interface.
 */
public interface Panel extends DomElement {
	...
	/**
	 * Returns the value of the framable child.
	 * @return the value of the framable child.
	 */
	@NotNull
	GenericAttributeValue<String> getFramable();
	...
	/**
	 * Returns the value of the collapsible child.
	 * @return the value of the collapsible child.
	 */
	@NotNull
	GenericAttributeValue<String> getCollapsible();


	/**
	 * Returns the value of the floatable child.
	 * @return the value of the floatable child.
	 */
	@NotNull
	GenericAttributeValue<String> getFloatable();
	...
	/**
	 * Returns the value of the movable child.
	 * @return the value of the movable child.
	 */
	@NotNull
	GenericAttributeValue<String> getMovable();
	...
	/**
	 * Returns the value of the panelchildren child.
	 * @return the value of the panelchildren child.
	 */
	@NotNull
	@Required
