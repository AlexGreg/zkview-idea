...
/**
 * http://www.zkoss.org/2005/zul:splitterType interface.
 */
public interface Splitter extends DomElement {
	...
	/**
	 * Returns the value of the collapse child.
	 * @return the value of the collapse child.
	 */
	@NotNull
	GenericAttributeValue<String> getCollapse();
