...
/**
 * http://www.zkoss.org/2005/zul:timerType interface.
 */
public interface Timer extends DomElement {
	 ...
	 */
	@NotNull
	GenericAttributeValue<Integer> getDelay();


	/**
	 * Returns the value of the repeats child.
	 * @return the value of the repeats child.
	 */
	@NotNull
	GenericAttributeValue<String> getRepeats();


	/**
	 * Returns the value of the running child.
	 * @return the value of the running child.
	 */
	@NotNull
	GenericAttributeValue<String> getRunning();


	/**
	 * Returns the value of the onTimer child.
	 * @return the value of the onTimer child.
	 */
	@NotNull
	GenericAttributeValue<String> getOnTimer();
