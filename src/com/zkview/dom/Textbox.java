...
/**
 * http://www.zkoss.org/2005/zul:textboxType interface.
 */
public interface Textbox extends DomElement {
	...
	/**
	 * Returns the value of the multiline child.
	 * @return the value of the multiline child.
	 */
	@NotNull
	GenericAttributeValue<String> getMultiline();


	/**
	 * Returns the value of the tabbable child.
	 * @return the value of the tabbable child.
	 */
	@NotNull
	GenericAttributeValue<String> getTabbable();
