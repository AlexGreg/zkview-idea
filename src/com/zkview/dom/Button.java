...
/**
 * http://www.zkoss.org/2005/zul:buttonType interface.
 */
public interface Button extends DomElement {
	...
	/**
	 * Returns the value of the autodisable child.
	 * @return the value of the autodisable child.
	 */
	@NotNull
	GenericAttributeValue<String> getAutodisable();
