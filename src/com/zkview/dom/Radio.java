...
/**
 * http://www.zkoss.org/2005/zul:radioType interface.
 */
public interface Radio extends DomElement {
	 ...
	 */
	@NotNull
	GenericAttributeValue<String> getSelected();


	/**
	 * Returns the value of the checked child.
	 * @return the value of the checked child.
	 */
	@NotNull
	GenericAttributeValue<String> getChecked();
	...
	/**
	 * Returns the value of the onCheck child.
	 * @return the value of the onCheck child.
	 */
	@NotNull
	GenericAttributeValue<String> getOnCheck();
	 ...
	 */
	@NotNull
	GenericAttributeValue<String> getRadiogroup();
