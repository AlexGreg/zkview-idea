...
/**
 * http://www.zkoss.org/2005/zul:chartType interface.
 */
public interface Chart extends DomElement {
	...
	/**
	 * Returns the value of the xAxis child.
	 * @return the value of the xAxis child.
	 */
	@NotNull
	GenericAttributeValue<String> getXAxis();


	/**
	 * Returns the value of the yAxis child.
	 * @return the value of the yAxis child.
	 */
	@NotNull
	GenericAttributeValue<String> getYAxis();


	/**
	 * Returns the value of the threeD child.
	 * @return the value of the threeD child.
	 */
	@NotNull
	GenericAttributeValue<String> getThreeD();


	/**
	 * Returns the value of the showLegend child.
	 * @return the value of the showLegend child.
	 */
	@NotNull
	GenericAttributeValue<String> getShowLegend();


	/**
	 * Returns the value of the showTooltiptext child.
	 * @return the value of the showTooltiptext child.
	 */
	@NotNull
	GenericAttributeValue<String> getShowTooltiptext();


	/**
	 * Returns the value of the paneAlpha child.
	 * @return the value of the paneAlpha child.
	 */
	@NotNull
	GenericAttributeValue<String> getPaneAlpha();


	/**
	 * Returns the value of the paneColor child.
	 * @return the value of the paneColor child.
	 */
	@NotNull
	GenericAttributeValue<String> getPaneColor();


	/**
	 * Returns the value of the fgAlpha child.
	 * @return the value of the fgAlpha child.
	 */
	@NotNull
	GenericAttributeValue<String> getFgAlpha();


	/**
	 * Returns the value of the bgAlpha child.
	 * @return the value of the bgAlpha child.
	 */
	@NotNull
	GenericAttributeValue<String> getBgAlpha();


	/**
	 * Returns the value of the bgColor child.
	 * @return the value of the bgColor child.
	 */
	@NotNull
	GenericAttributeValue<String> getBgColor();
	 ...
	 */
	@NotNull
	GenericAttributeValue<String> getPeriod();


	/**
	 * Returns the value of the areaListener child.
	 * @return the value of the areaListener child.
	 */
	@NotNull
	GenericAttributeValue<String> getAreaListener();
