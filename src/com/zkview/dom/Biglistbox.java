...
/**
 * http://www.zkoss.org/2005/zul:biglistboxType interface.
 */
public interface Biglistbox extends DomElement {
	...
	/**
	 * Returns the value of the frozenCols child.
	 * @return the value of the frozenCols child.
	 */
	@NotNull
	GenericAttributeValue<Integer> getFrozenCols();
	 ...
	 */
	@NotNull
	GenericAttributeValue<String> getRowHeight();


	/**
	 * Returns the value of the colWidth child.
	 * @return the value of the colWidth child.
	 */
	@NotNull
	GenericAttributeValue<String> getColWidth();


	/**
	 * Returns the value of the maxtrixRenderer child.
	 * @return the value of the maxtrixRenderer child.
	 */
	@NotNull
	GenericAttributeValue<String> getMaxtrixRenderer();
	...
	/**
	 * Returns the value of the onScrollX child.
	 * @return the value of the onScrollX child.
	 */
	@NotNull
	GenericAttributeValue<String> getOnScrollX();


	/**
	 * Returns the value of the onScrollY child.
	 * @return the value of the onScrollY child.
	 */
	@NotNull
	GenericAttributeValue<String> getOnScrollY();


	/**
	 * Returns the value of the onCellClick child.
	 * @return the value of the onCellClick child.
	 */
	@NotNull
	GenericAttributeValue<String> getOnCellClick();


	/**
	 * Returns the value of the onAfterRender child.
	 * @return the value of the onAfterRender child.
	 */
	@NotNull
	GenericAttributeValue<String> getOnAfterRender();
