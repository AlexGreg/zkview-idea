...
/**
 * http://www.zkoss.org/2005/zul:flashType interface.
 */
public interface Flash extends DomElement {
	...
	/**
	 * Returns the value of the wmode child.
	 * @return the value of the wmode child.
	 */
	@NotNull
	GenericAttributeValue<String> getWmode();
