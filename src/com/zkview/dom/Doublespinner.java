...
/**
 * http://www.zkoss.org/2005/zul:doublespinnerType interface.
 */
public interface Doublespinner extends DomElement {
	...
	/**
	 * Returns the value of the roundingMode child.
	 * @return the value of the roundingMode child.
	 */
	@NotNull
	GenericAttributeValue<Integer> getRoundingMode();
	 ...
	 */
	@NotNull
	GenericAttributeValue<Double> getStep();
