...
/**
 * http://www.zkoss.org/2005/zul:pivottableType interface.
 */
public interface Pivottable extends DomElement {
	...
	/**
	 * Returns the value of the activePage child.
	 * @return the value of the activePage child.
	 */
	@NotNull
	GenericAttributeValue<Integer> getActivePage();


	/**
	 * Returns the value of the totalSize child.
	 * @return the value of the totalSize child.
	 */
	@NotNull
	GenericAttributeValue<Integer> getTotalSize();


	/**
	 * Returns the value of the grandTotalForRows child.
	 * @return the value of the grandTotalForRows child.
	 */
	@NotNull
	GenericAttributeValue<String> getGrandTotalForRows();


	/**
	 * Returns the value of the grandTotalForColumns child.
	 * @return the value of the grandTotalForColumns child.
	 */
	@NotNull
	GenericAttributeValue<String> getGrandTotalForColumns();


	/**
	 * Returns the value of the dataFieldOrient child.
	 * @return the value of the dataFieldOrient child.
	 */
	@NotNull
	GenericAttributeValue<String> getDataFieldOrient();
	...
	/**
	 * Returns the value of the pivotRenderer child.
	 * @return the value of the pivotRenderer child.
	 */
	@NotNull
	GenericAttributeValue<String> getPivotRenderer();
