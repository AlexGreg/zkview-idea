...
/**
 * http://www.zkoss.org/2005/zul:rowType interface.
 */
public interface Row extends DomElement {
	...
	/**
	 * Returns the value of the nowrap child.
	 * @return the value of the nowrap child.
	 */
	@NotNull
	GenericAttributeValue<String> getNowrap();


	/**
	 * Returns the value of the spans child.
	 * @return the value of the spans child.
	 */
	@NotNull
	GenericAttributeValue<String> getSpans();
	...
	/**
	 * Returns the value of the detail child.
	 * @return the value of the detail child.
	 */
	@NotNull
	@Required
	Detail getDetail();
