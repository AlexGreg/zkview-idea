...
/**
 * http://www.zkoss.org/2005/zul:auxheadType interface.
 */
public interface Auxhead extends DomElement {
	...
	/**
	 * Returns the list of auxheader children.
	 * @return the list of auxheader children.
	 */
	@NotNull
	List<Auxheader> getAuxheaders();
	/**
	 * Adds new child to the list of auxheader children.
	 * @return created child
	 */
	Auxheader addAuxheader();
