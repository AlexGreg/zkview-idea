...
/**
 * http://www.zkoss.org/2005/zul:separatorType interface.
 */
public interface Separator extends DomElement {
	...
	/**
	 * Returns the value of the bar child.
	 * @return the value of the bar child.
	 */
	@NotNull
	GenericAttributeValue<String> getBar();
