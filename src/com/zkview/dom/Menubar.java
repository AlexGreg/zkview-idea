...
/**
 * http://www.zkoss.org/2005/zul:menubarType interface.
 */
public interface Menubar extends DomElement {
	...
	/**
	 * Returns the value of the scrollable child.
	 * @return the value of the scrollable child.
	 */
	@NotNull
	GenericAttributeValue<String> getScrollable();
