...
/**
 * http://www.zkoss.org/2005/zul:pagingType interface.
 */
public interface Paging extends DomElement {
	...
	/**
	 * Returns the value of the pageIncrement child.
	 * @return the value of the pageIncrement child.
	 */
	@NotNull
	GenericAttributeValue<Integer> getPageIncrement();


	/**
	 * Returns the value of the detailed child.
	 * @return the value of the detailed child.
	 */
	@NotNull
	GenericAttributeValue<String> getDetailed();


	/**
	 * Returns the value of the autohide child.
	 * @return the value of the autohide child.
	 */
	@NotNull
	GenericAttributeValue<String> getAutohide();
