...
/**
 * http://www.zkoss.org/2005/zul:borderlayoutType interface.
 */
public interface Borderlayout extends DomElement {
	...
	/**
	 * Returns the value of the animationDisabled child.
	 * @return the value of the animationDisabled child.
	 */
	@NotNull
	GenericAttributeValue<String> getAnimationDisabled();
	...
	/**
	 * Returns the value of the north child.
	 * @return the value of the north child.
	 */
	@NotNull
	North getNorth();
	...
	/**
	 * Returns the value of the south child.
	 * @return the value of the south child.
	 */
	@NotNull
	South getSouth();
	...
	/**
	 * Returns the value of the center child.
	 * @return the value of the center child.
	 */
	@NotNull
	Center getCenter();
	...
	/**
	 * Returns the value of the west child.
	 * @return the value of the west child.
	 */
	@NotNull
	West getWest();
	...
	/**
	 * Returns the value of the east child.
	 * @return the value of the east child.
	 */
	@NotNull
	East getEast();
