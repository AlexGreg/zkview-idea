...
/**
 * http://www.zkoss.org/2005/zul:chosenboxType interface.
 */
public interface Chosenbox extends DomElement {
	...
	/**
	 * Returns the value of the creatable child.
	 * @return the value of the creatable child.
	 */
	@NotNull
	GenericAttributeValue<String> getCreatable();


	/**
	 * Returns the value of the createMessage child.
	 * @return the value of the createMessage child.
	 */
	@NotNull
	GenericAttributeValue<String> getCreateMessage();
	...
	/**
	 * Returns the value of the noResultsText child.
	 * @return the value of the noResultsText child.
	 */
	@NotNull
	GenericAttributeValue<String> getNoResultsText();
