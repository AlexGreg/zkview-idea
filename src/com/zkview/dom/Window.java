...
/**
 * http://www.zkoss.org/2005/zul:windowType interface.
 */
public interface Window extends DomElement {
	...
	/**
	 * Returns the value of the border child.
	 * @return the value of the border child.
	 */
	@NotNull
	GenericAttributeValue<String> getBorder();
	...
	/**
	 * Returns the value of the closable child.
	 * @return the value of the closable child.
	 */
	@NotNull
	GenericAttributeValue<String> getClosable();


	/**
	 * Returns the value of the sizable child.
	 * @return the value of the sizable child.
	 */
	@NotNull
	GenericAttributeValue<String> getSizable();
	...
	/**
	 * Returns the value of the contentStyle child.
	 * @return the value of the contentStyle child.
	 */
	@NotNull
	GenericAttributeValue<String> getContentStyle();


	/**
	 * Returns the value of the minheight child.
	 * @return the value of the minheight child.
	 */
	@NotNull
	GenericAttributeValue<Integer> getMinheight();


	/**
	 * Returns the value of the minwidth child.
	 * @return the value of the minwidth child.
	 */
	@NotNull
	GenericAttributeValue<Integer> getMinwidth();


	/**
	 * Returns the value of the defaultActionOnShow child.
	 * @return the value of the defaultActionOnShow child.
	 */
	@NotNull
	GenericAttributeValue<String> getDefaultActionOnShow();


	/**
	 * Returns the value of the maximizable child.
	 * @return the value of the maximizable child.
	 */
	@NotNull
	GenericAttributeValue<String> getMaximizable();


	/**
	 * Returns the value of the maximized child.
	 * @return the value of the maximized child.
	 */
	@NotNull
	GenericAttributeValue<String> getMaximized();


	/**
	 * Returns the value of the minimized child.
	 * @return the value of the minimized child.
	 */
	@NotNull
	GenericAttributeValue<String> getMinimized();


	/**
	 * Returns the value of the minimizable child.
	 * @return the value of the minimizable child.
	 */
	@NotNull
	GenericAttributeValue<String> getMinimizable();


	/**
	 * Returns the value of the contentSclass child.
	 * @return the value of the contentSclass child.
	 */
	@NotNull
	GenericAttributeValue<String> getContentSclass();
	...
	/**
	 * Returns the value of the onOK child.
	 * @return the value of the onOK child.
	 */
	@NotNull
	GenericAttributeValue<String> getOnOK();


	/**
	 * Returns the value of the onCancel child.
	 * @return the value of the onCancel child.
	 */
	@NotNull
	GenericAttributeValue<String> getOnCancel();


	/**
	 * Returns the value of the onMove child.
	 * @return the value of the onMove child.
	 */
	@NotNull
	GenericAttributeValue<String> getOnMove();


	/**
	 * Returns the value of the onOpen child.
	 * @return the value of the onOpen child.
	 */
	@NotNull
	GenericAttributeValue<String> getOnOpen();


	/**
	 * Returns the value of the onClose child.
	 * @return the value of the onClose child.
	 */
	@NotNull
	GenericAttributeValue<String> getOnClose();


	/**
	 * Returns the value of the onZIndex child.
	 * @return the value of the onZIndex child.
	 */
	@NotNull
	GenericAttributeValue<String> getOnZIndex();
	...
	/**
	 * Returns the value of the caption child.
	 * @return the value of the caption child.
	 */
	@NotNull
	@Required
	Caption getCaption();
