...
/**
 * http://www.zkoss.org/2005/zul:anchorlayoutType interface.
 */
public interface Anchorlayout extends DomElement {
	...
	/**
	 * Returns the list of anchorchildren children.
	 * @return the list of anchorchildren children.
	 */
	@NotNull
	List<Anchorchildren> getAnchorchildrens();
	/**
	 * Adds new child to the list of anchorchildren children.
	 * @return created child
	 */
	Anchorchildren addAnchorchildren();
