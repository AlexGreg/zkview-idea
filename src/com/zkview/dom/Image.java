...
/**
 * http://www.zkoss.org/2005/zul:imageType interface.
 */
public interface Image extends DomElement {
	...
	/**
	 * Returns the value of the hover child.
	 * @return the value of the hover child.
	 */
	@NotNull
	GenericAttributeValue<String> getHover();


	/**
	 * Returns the value of the hoverContent child.
	 * @return the value of the hoverContent child.
	 */
	@NotNull
	GenericAttributeValue<String> getHoverContent();
