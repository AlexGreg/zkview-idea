...
/**
 * http://www.zkoss.org/2005/zul:listheadType interface.
 */
public interface Listhead extends DomElement {
	 ...
	 */
	@NotNull
	GenericAttributeValue<String> getMenupopup();


	/**
	 * Returns the value of the columnshide child.
	 * @return the value of the columnshide child.
	 */
	@NotNull
	GenericAttributeValue<String> getColumnshide();


	/**
	 * Returns the value of the columnsgroup child.
	 * @return the value of the columnsgroup child.
	 */
	@NotNull
	GenericAttributeValue<String> getColumnsgroup();
