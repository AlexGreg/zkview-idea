...
/**
 * http://www.zkoss.org/2005/zul:portallayoutType interface.
 */
public interface Portallayout extends DomElement {
	...
	/**
	 * Returns the list of portalchildren children.
	 * @return the list of portalchildren children.
	 */
	@NotNull
	List<Portalchildren> getPortalchildrens();
	/**
	 * Adds new child to the list of portalchildren children.
	 * @return created child
	 */
	Portalchildren addPortalchildren();
