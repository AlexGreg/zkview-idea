...
/**
 * http://www.zkoss.org/2005/zul:radiogroupType interface.
 */
public interface Radiogroup extends DomElement {
	...
	/**
	 * Returns the value of the radioRenderer child.
	 * @return the value of the radioRenderer child.
	 */
	@NotNull
	GenericAttributeValue<String> getRadioRenderer();
