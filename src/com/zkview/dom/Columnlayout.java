...
/**
 * http://www.zkoss.org/2005/zul:columnlayoutType interface.
 */
public interface Columnlayout extends DomElement {
	...
	/**
	 * Returns the list of columnchildren children.
	 * @return the list of columnchildren children.
	 */
	@NotNull
	List<Columnchildren> getColumnchildrens();
	/**
	 * Adds new child to the list of columnchildren children.
	 * @return created child
	 */
	Columnchildren addColumnchildren();
