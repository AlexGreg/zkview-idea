...
/**
 * http://www.zkoss.org/2005/zul:fusionchartType interface.
 */
public interface Fusionchart extends DomElement {
	...
	/**
	 * Returns the value of the tableModel child.
	 * @return the value of the tableModel child.
	 */
	@NotNull
	GenericAttributeValue<String> getTableModel();


	/**
	 * Returns the value of the chartConfig child.
	 * @return the value of the chartConfig child.
	 */
	@NotNull
	GenericAttributeValue<String> getChartConfig();


	/**
	 * Returns the value of the tableRenderer child.
	 * @return the value of the tableRenderer child.
	 */
	@NotNull
	GenericAttributeValue<String> getTableRenderer();


	/**
	 * Returns the value of the engine child.
	 * @return the value of the engine child.
	 */
	@NotNull
	...
	/**
	 * Returns the value of the dataXMLPath child.
	 * @return the value of the dataXMLPath child.
	 */
	@NotNull
	GenericAttributeValue<String> getDataXMLPath();
	...
	/**
	 * Returns the value of the subTitle child.
	 * @return the value of the subTitle child.
	 */
	@NotNull
	GenericAttributeValue<String> getSubTitle();
