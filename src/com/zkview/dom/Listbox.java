...
/**
 * http://www.zkoss.org/2005/zul:listboxType interface.
 */
public interface Listbox extends DomElement {
	...
	/**
	 * Returns the value of the checkmark child.
	 * @return the value of the checkmark child.
	 */
	@NotNull
	GenericAttributeValue<String> getCheckmark();
	...
	/**
	 * Returns the value of the paginal child.
	 * @return the value of the paginal child.
	 */
	@NotNull
	GenericAttributeValue<String> getPaginal();


	/**
	 * Returns the value of the onPaging child.
	 * @return the value of the onPaging child.
	 */
	@NotNull
	GenericAttributeValue<String> getOnPaging();
	 ...
	 */
	@NotNull
	GenericAttributeValue<String> getMultiple();
	...
	/**
	 * Returns the value of the maxlength child.
	 * @return the value of the maxlength child.
	 */
	@NotNull
	GenericAttributeValue<Integer> getMaxlength();
	...
	/**
	 * Returns the value of the oddRowSclass child.
	 * @return the value of the oddRowSclass child.
	 */
	@NotNull
	GenericAttributeValue<String> getOddRowSclass();


	/**
	 * Returns the value of the selectedItem child.
	 * @return the value of the selectedItem child.
	 */
	@NotNull
	GenericAttributeValue<String> getSelectedItem();


	/**
	 * Returns the value of the selectedIndex child.
	 * @return the value of the selectedIndex child.
	 */
	@NotNull
	GenericAttributeValue<Integer> getSelectedIndex();


	/**
	 * Returns the value of the tabindex child.
	 * @return the value of the tabindex child.
	 */
	@NotNull
	GenericAttributeValue<Integer> getTabindex();
	...
	/**
	 * Returns the value of the itemRenderer child.
	 * @return the value of the itemRenderer child.
	 */
	@NotNull
	GenericAttributeValue<String> getItemRenderer();


	/**
	 * Returns the value of the sizedByContent child.
	 * @return the value of the sizedByContent child.
	 */
	@NotNull
	GenericAttributeValue<String> getSizedByContent();


	/**
	 * Returns the value of the onSelect child.
	 * @return the value of the onSelect child.
	 */
	@NotNull
	GenericAttributeValue<String> getOnSelect();
	...
	/**
	 * Returns the value of the pagingPosition child.
	 * @return the value of the pagingPosition child.
	 */
	@NotNull
	GenericAttributeValue<String> getPagingPosition();


	/**
	 * Returns the value of the innerWidth child.
	 * @return the value of the innerWidth child.
	 */
	@NotNull
	GenericAttributeValue<String> getInnerWidth();


	/**
	 * Returns the value of the nonselectableTags child.
	 * @return the value of the nonselectableTags child.
	 */
	@NotNull
	GenericAttributeValue<String> getNonselectableTags();


	/**
	 * Returns the value of the autopaging child.
	 * @return the value of the autopaging child.
	 */
	@NotNull
	GenericAttributeValue<String> getAutopaging();


	/**
	 * Returns the value of the emptyMessage child.
	 * @return the value of the emptyMessage child.
	 */
	@NotNull
	GenericAttributeValue<String> getEmptyMessage();


	/**
	 * Returns the list of auxhead children.
	 * @return the list of auxhead children.
	 */
	@NotNull
	List<Auxhead> getAuxheads();
	/**
	 * Adds new child to the list of auxhead children.
	...
	/**
	 * Returns the value of the listhead child.
	 * @return the value of the listhead child.
	 */
	@NotNull
	@Required
	...
	/**
	 * Returns the value of the listfoot child.
	 * @return the value of the listfoot child.
	 */
	@NotNull
	@Required
