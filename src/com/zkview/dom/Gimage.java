...
/**
 * http://www.zkoss.org/2005/zul:gimageType interface.
 */
public interface Gimage extends DomElement {
	...
	/**
	 * Returns the value of the swlng child.
	 * @return the value of the swlng child.
	 */
	@NotNull
	GenericAttributeValue<Double> getSwlng();


	/**
	 * Returns the value of the swlat child.
	 * @return the value of the swlat child.
	 */
	@NotNull
	GenericAttributeValue<Double> getSwlat();


	/**
	 * Returns the value of the nelng child.
	 * @return the value of the nelng child.
	 */
	@NotNull
	GenericAttributeValue<Double> getNelng();


	/**
	 * Returns the value of the nelat child.
	 * @return the value of the nelat child.
	 */
	@NotNull
	GenericAttributeValue<Double> getNelat();
