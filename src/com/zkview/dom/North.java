...
/**
 * http://www.zkoss.org/2005/zul:northType interface.
 */
public interface North extends DomElement, AnyGroupSingle {
	...
	/**
	 * Returns the value of the flex child.
	 * @return the value of the flex child.
	 */
	@NotNull
	GenericAttributeValue<String> getFlex();
	...
	/**
	 * Returns the value of the splittable child.
	 * @return the value of the splittable child.
	 */
	@NotNull
	GenericAttributeValue<String> getSplittable();
	...
	/**
	 * Returns the value of the margins child.
	 * @return the value of the margins child.
	 */
	@NotNull
	GenericAttributeValue<String> getMargins();
	...
	/**
	 * Returns the value of the autoscroll child.
	 * @return the value of the autoscroll child.
	 */
	@NotNull
	GenericAttributeValue<String> getAutoscroll();
	...
	/**
	 * Returns the value of the maxsize child.
	 * @return the value of the maxsize child.
	 */
	@NotNull
	GenericAttributeValue<Integer> getMaxsize();
