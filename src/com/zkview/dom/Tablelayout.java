...
/**
 * http://www.zkoss.org/2005/zul:tablelayoutType interface.
 */
public interface Tablelayout extends DomElement {
	 ...
	 */
	@NotNull
	GenericAttributeValue<Integer> getColumns();
	...
	/**
	 * Returns the list of tablechildren children.
	 * @return the list of tablechildren children.
	 */
	@NotNull
	List<Tablechildren> getTablechildrens();
	/**
	 * Adds new child to the list of tablechildren children.
	 * @return created child
	 */
	Tablechildren addTablechildren();
