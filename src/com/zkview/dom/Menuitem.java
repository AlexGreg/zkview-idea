...
/**
 * http://www.zkoss.org/2005/zul:menuitemType interface.
 */
public interface Menuitem extends DomElement {
	...
	/**
	 * Returns the value of the autocheck child.
	 * @return the value of the autocheck child.
	 */
	@NotNull
	GenericAttributeValue<String> getAutocheck();
