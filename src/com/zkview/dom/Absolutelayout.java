...
/**
 * http://www.zkoss.org/2005/zul:absolutelayoutType interface.
 */
public interface Absolutelayout extends DomElement {
	...
	/**
	 * Returns the list of absolutechildren children.
	 * @return the list of absolutechildren children.
	 */
	@NotNull
	List<Absolutechildren> getAbsolutechildrens();
	/**
	 * Adds new child to the list of absolutechildren children.
	 * @return created child
	 */
	Absolutechildren addAbsolutechildren();
